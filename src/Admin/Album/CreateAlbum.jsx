...
const CreateAlbum = () => {
  ...
  return (
    <section className="w-full flex flex-col justify-center items-center p-6 bg-gray-200">
      ...
      <main className="w-full bg-gray-800 rounded-b-md p-6">
        <form onSubmit={handleSubmit} className="w-full">
          <div className="flex flex-wrap justify-evenly gap-4 ">
            <div className="w-[30%] flex flex-col">
              <label htmlFor="albumTitle" className="text-lg font-semibold text-white mb-2">
                Album Title
              </label>
              <input
                type="text"
                name="albumTitle"
                id="albumTitle"
                className="border border-gray-500 py-2 rounded bg-gray-700 text-white text-lg px-2 outline-none"
                value={albumTitle}
            ...
            <div className="w-[30%] flex flex-col">
              <label htmlFor="albumLang" className="text-lg font-semibold text-white mb-2">
                Album Language
              </label>
              <input
                type="text"
            ...
            <div className="w-[30%] flex flex-col">
              <label htmlFor="albumType" className="text-lg font-semibold text-white mb-2">
                Album Type
              </label>
              <input
                type="text"
          ...
          <div className="flex flex-wrap justify-evenly gap-4 mt-4 ">
            <div className="w-[48%] flex flex-col">
              <label htmlFor="albumDesc" className="text-lg font-semibold text-white mb-2">
                Album Description
              </label>
              <textarea
                name="albumDesc"
                id="albumDesc"
                className="border border-gray-500 rounded bg-gray-700 text-white text-lg px-2 outline-none"
                value={albumDesc}
                onChange={handleAlbumInputChange}
            ...
            <div className="w-[48%] flex flex-col">
              <label htmlFor="albumThumbnail" className="text-lg font-semibold text-white mb-2">
              ...
              <input
                ...
                name="albumThumbnail"
                id="albumThumbnail"
                className="border border-gray-500 py-2 rounded bg-gray-700 text-white text-lg px-2 outline-none file:bg-gray-600 cursor-pointer file:cursor-pointer file:text-white file:rounded file:p-1 file:text-sm"
          ...
          <div className=" flex justify-evenly py-2 ">
            ...
            <div className="w-[350px] flex flex-col pl-6">
              <label
          ...
          <article className="w-full flex flex-col items-center mt-4">
            <header className="w-[95%] bg-gray-900 rounded">
              <h1 className="text-3xl text-center uppercase font-bold py-3 text-white">
                Add Songs
              </h1>
            </header>
            {songDetails.map((song, index) => (
              <section
                key={index}
                className="bg-gray-700 w-[95%] flex flex-col m-auto mt-3 rounded-lg"
              >
                <header>
                  <h1 className="text-2xl font-semibold px-4 py-2 text-white">
                    Song-{index + 1}
                  </h1>
                </header>
                  ...
                  <div className="flex justify-around py-2">
                    <div className="w-[530px] flex flex-col">
                      ...
                      <input
                        ...
                        name="songThumbnail"
                        id="songThumbnail"
                        className="border border-gray-500 py-2 rounded bg-gray-600 text-white text-lg px-2 outline-none file:bg-gray-500 cursor-pointer file:cursor-pointer file:text-white file:rounded file:p-1 file:text-sm"
                ...
                <section className="flex justify-between">
                  ...
                  <aside className="flex px-8 mb-4">
                    {songDetails.length !== 1 && (
                      ...
                      >
                        <span className="font-semibold text-white">Remove Song</span>
                        <span className="text-lg text-white">
                          <IoIosRemoveCircle />
                        </span>
                      </div>
          ...
          <article className="my-5 w-full flex justify-center items-center">
            <button className="w-[95%] py-2 text-lg font-semibold bg-blue-600 hover:bg-blue-700 rounded-lg mt-2 cursor-pointer text-white">
